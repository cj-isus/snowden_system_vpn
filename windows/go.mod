...
require (
	...
	github.com/sagernet/sing-box v1.14.0-lx.2
	github.com/wailsapp/wails/v2 v2.13.0
	golang.org/x/sys v0.47.0
)

// Use sing-box-lx (Leadaxe's thin fork) instead of upstream sing-box.
// Same module path (identity preserved per lx philosophy), but provides
// AmneziaWG 2.0, MASQUE, XHTTP and the CommandClient observability layer
// behind build tags (with_awg / with_xhttp / with_lx_command).
replace github.com/sagernet/sing-box => github.com/Leadaxe/sing-box-lx v1.14.0-lx.2
...
// replace github.com/wailsapp/wails/v2 v2.13.0 => C:\Users\Пользо\go\pkg\mod
